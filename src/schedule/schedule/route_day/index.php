                            ...
                            <div class="cont_head head2 nurse_record">
                                ...
                                <div class="search_wrap">
                                    <div class="s_wrap">
                                        ...
                                        <div class="checklist">
                                            <p><input type="checkbox" name="Search[type][]" id="check1" checked><label for="check1" value="看多機">看多機</label></p>
                                            <p><input type="checkbox" name="Search[type][]" id="check2" checked><label for="check2" value="訪問看護">訪問看護</label></p>
                                            <p><input type="checkbox" name="Search[type][]" id="check3" checked><label for="check3" value="未割当">未割当</label></p>
                                        </div>
