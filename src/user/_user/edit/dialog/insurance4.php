        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="text" name="upDummy[ins4_end_dt]" maxlength="2" pattern="^[0-9]+$" value="" id="birth_d" class="validate[maxSize[2],onlyNumberSp] b_ymd w10 ins4_end_day" placeholder="半角数字2桁"><label for="birth_d">日</label>
