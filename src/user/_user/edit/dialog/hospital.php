    ...
    <table>
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name='upHsp[name]' id="med_institution-n" maxlength="30" value="" class="validate[maxSize[30]] note1 hsp_name" style="width:300px;" placeholder="30文字以内"><span>帳票類の印刷時に出力されます</span>
                </td>
            </tr>
            <tr>
                <th class="tac">レセプト出力用名称</th>
                <td>
                    <input type="text" name="upHsp[disp_name]" id="receipt_name" maxlength="16" value="" class="validate[maxSize[16]] hsp_disp_name bg-gray2" style="width:300px;" readonly="true" placeholder="16文字以内">
                </td>
            </tr>
            <tr>
