                                        ...
                                        <div class="box-l">
                                            ...
                                            <div class="aff_box">
                                                <table id="affliate_add">
                                                    <thead>
                                                        <tr>
                                                            <th>所属拠点<span class="req">*</span></th>
                                                            <th>所属事業所<span class="req">*</span></th>
                                                            <th colspan="2"><div class="btn add add2 addBase">拠点追加</div></th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <?php if(empty($dispOfc)) : ?>
                                                            <tr>
                                                                ...
                                                                <td class="office_in">
                                                                    <div>
                                                                        <select name="upOfc[0][office1_id]" style="width:330px;" required>
                                                                            <option></option>
                                                                    ...
                                                                    <div>
                                                                        <select name="upOfc[0][office2_id]" class="" style="width:330px;">
                                                                            <option></option>
                                                                            <?php foreach ($plcOfc as $plcId => $plcOfc2): ?>
                                                                                <?php foreach ($plcOfc2 as $ofcId => $ofcName): ?>
                                                                                    <option class="cngPlace" data-place_id="<?= $plcId ?>" data-place_name="<?= $plcList[$plcId]['name'] ?>" value="<?= $ofcId ?>" ><?= $ofcName ?></option>
