                            ...
                            <form action="" class="p-form-validate" method="get">
                                <div class="user-details nurse_record">
                                    ...
                                    <div class="shain_info">
                                        <span><label for="emp_ID">社員ID</label><input type="text" name="sAry[staff_id]" id="emp_ID" value="<?= $dispSearch['staff_id'] ?>"></span>
                                        <span><label for="emp_name">氏名</label><input type="text" name="sAry[name]" id="emp_name" value="<?= $dispSearch['name'] ?>"></span>
                                        <span><input type="checkbox" name="sAry[retired]" id="dis_retiree" value="1" <?= ($dispSearch['retired'] != '') ? 'checked' : '' ?>><label for="dis_retiree">退職者表示</label></span>
                                    </div>
                                    <div class="s_control">
                                    ...
                                    <table class="dis_result">
                                        ...
                                        <?php foreach ($dispData as $tgtId => $val): ?>
                                            <tr>
                                                ...
                                                <td><?= $val['emg_tel'] ?></td>
                                                <td><?= $val['retired'] == '1' ? '<div class="retire_btn">退職</div>' : '' ?></td>
                                                <td><span class="btn edit" style="padding: 0px;"><a href="/system/staff_edit?id=<?= $tgtId ?>">編集</a></span></td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </table>
                                </div> 
