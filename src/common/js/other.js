...
// NAVIGATION HEADER //////////////////////////////////////////////////////////////////
$(function () {
  $('#header .search_box .search').click(function () {
    $(this).closest('.search_box').find('.search_list').toggle();
  });
  $('#header .switch_btn').click(function () {
    $(this).next('.switch_box').toggle();
  });
  $('header .notif_bell').click(function () {
    $(this).next('.notif_cont').toggle();
  });
  $('header .acct_log').click(function () {
    $(this).next('.acct_box').toggle();
  });
...
$(function () {
  ...
  $('.prev_month').click(function () {
    const p_firstDay = new Date(
      currentMonth.getFullYear(),
      currentMonth.getMonth() - 1,
      1
    );
    const p_lastDay = new Date(
      currentMonth.getFullYear(),
  ...
  $('.this_month').click(function () {
    const t_firstDay = new Date(
      currentMonth.getFullYear(),
      currentMonth.getMonth(),
      1
    );
    const t_lastDay = new Date(
      currentMonth.getFullYear(),
      currentMonth.getMonth() + 1,
      0
    );
  ...
  $('.next_month').click(function () {
    const n_firstDay = new Date(
      currentMonth.getFullYear(),
      currentMonth.getMonth() + 1,
      1
    );
    const n_lastDay = new Date(
      currentMonth.getFullYear(),
...
$('.accor_tab li').click(function () {
  const num = $(".accor_tab li").index(this);
...
// 初期表示
const param = location.hash; /* パラメータ取得 */
$('.con_box').addClass('disnon');
$('.accor_tab li').removeClass('active');
if (param) {
  // パラメータ指定時タブ初期表示変更
  ...
  var num = num - 1;
  const tgt = ".con-box:nth-child(" + num + ")";
  $('.con_box').eq(num).removeClass('disnon');
...
$(function () {
  $('.nurse_record .category input[type=radio]').click(function () {
    const num = $(".nurse_record .category input[type=radio]").index(this);
...
$(function () {
  ...
  $('.search_drop').click(function () {
    $(this).toggleClass('active').next().slideToggle().toggleClass('is_open');
  });

  $('.tit_toggle').click(function () {
    if (window.innerWidth < 700) {
      $(this).toggleClass('inactive').nextAll('.child_toggle').slideToggle();
    }
  });

  // USER DETAIL HISTORY BOX
  $('.tit_toggle2').click(function () {
    $(this).toggleClass('inactive').next().slideToggle();
  });
});
...
$(function () {
  ...
  $('.target_data input[type=radio]').click(function () {
    const num = $(".target_data input[type=radio]").index(this);
...
$(function () {
  $('.add_sub_btn').click(function () {
    const ol_wrap = $(this).closest(".add_sub").find("ol");
    let new_list = '';
...
$(function () {
  $('.display_switch').click(function () {
    $('.p-form-validate').toggleClass('is_open');
  });
});
